...
def update(attr, old, new):
    ...
    if item!='all':
        reviews_ms1 = reviews[reviews['title']==item]
    ...
    z = plot_all(category,topic_distribution,topics_lda1)
...
def plot_rows(reviews_ms1):
    ...
    for i in range(10):
        footer_text1 = footer_text1+reviews_ms1.comments.iloc[i]+"""</br>"""
...
controls = row([ticker1, ticker2 ])#, width=200)
